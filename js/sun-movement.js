...
//// This code is almost an identical copy of wayPoint mover, but because we 
//// had to change that code to despawn objects upon reaching the last
//// waypoint, We just made another copy of the original code that resets the position of the 
//// object. The sun crossing the sky will be the trigger for ending/ starting a level. 

//// TODO add a timer for respawning, and a boolean condition that temporarily stops spawners
//// if it is nighttime 
/*
